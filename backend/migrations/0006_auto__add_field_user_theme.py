...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.theme'
        db.add_column(u'backend_user', 'theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['common.Theme']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.theme'
        db.delete_column(u'backend_user', 'theme_id')
