...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Connector.version'
        db.add_column(u'backend_connector', 'version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'Connector.usable'
        db.add_column(u'backend_connector', 'usable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Connector.version'
        db.delete_column(u'backend_connector', 'version')

        # Deleting field 'Connector.usable'
        db.delete_column(u'backend_connector', 'usable')
