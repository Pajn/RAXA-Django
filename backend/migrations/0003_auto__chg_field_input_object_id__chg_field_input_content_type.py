...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Input.object_id'
        db.alter_column(u'backend_input', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Input.content_type'
        db.alter_column(u'backend_input', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Input.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Input.object_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Input.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Input.content_type' and its values cannot be restored.")
