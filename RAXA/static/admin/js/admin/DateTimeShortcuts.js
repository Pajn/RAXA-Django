...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        // set i the admin/base.html template, so if it's not there, someone's
        // overridden the template. In that case, we'll set a clearly-invalid
        // value i the hopes that someone will examine HTTP requests and see it.
    ...
    openClock: function(num) {
        ...
        if (getStyle(document.body,'direction')!='rtl') {
            ...
            // since style's width is i em, it'd be tough to calculate
            // px value of it. let's use an estimated px for now
            // TODO: IE returns wrong value for findPosX when i rtl mode
    ...
    openCalendar: function(num) {
        ...
        // Determine if the current value i the input has a valid date.
