...
(function($) {
	$.fn.formset = function(opts) {
		...
		if ($(this).length && showAddButton) {
			...
			addButton.click(function() {
				...
				if (row.is("tr")) {
					// If the forms are laid out i table rows, insert
				...
				nextIndex += 1;
				// Hide add button i case we've hit the max, except we want to add infinitely
	...
	$.fn.formset.defaults = {
		...
		formCssClass: "dynamic-form",	// CSS class applied to each form i a formset
